...
rmse_gaussian1 = decomposition_random_dictionary(
    Gaussian=True, rng=rng_global, n_features=65, n_dims=1
)
rmse_uniform1 = decomposition_random_dictionary(
    Gaussian=False, rng=rng_global, n_features=65, n_dims=1
)
rmse_gaussian2 = decomposition_random_dictionary(
    Gaussian=True, rng=rng_global, n_features=65, n_dims=3
)
rmse_uniform2 = decomposition_random_dictionary(
    Gaussian=False, rng=rng_global, n_features=65, n_dims=3
)
rmse_gaussian3 = decomposition_random_dictionary(
    Gaussian=True, rng=rng_global, n_features=65, n_dims=5
)
rmse_uniform3 = decomposition_random_dictionary(
    Gaussian=False, rng=rng_global, n_features=65, n_dims=5
)
...
uni.errorbar(
    range(1, n_nonzero_coefs + 1),
    rmse_gaussian1.mean(1),
    yerr=rmse_gaussian1.std(1),
    color="r",
    label="Gaussian",
)
...
mul1.errorbar(
    range(1, n_nonzero_coefs + 1),
    rmse_gaussian2.mean(1),
    yerr=rmse_gaussian2.std(1),
    color="r",
    label="Gaussian",
)
...
mul2.errorbar(
    range(1, n_nonzero_coefs + 1),
    rmse_gaussian3.mean(1),
    yerr=rmse_gaussian3.std(1),
    color="r",
    label="Gaussian",
)
